...
import {getCategoryAttributes, getCategoryConfig } from '@/lib/category-configs-final';

// Define CategoryConfig type locally if not exported from '@/types/product'
type CategoryConfig = {
  name: string;
  description: string;
...
interface CategoryBasedFormProps {
  ...
  formData: Record<string, string | number | boolean | string[] | FileList | null>;
  errors: Record<string, string>;
  onFormDataChange: (fieldId: string, value: string | number | boolean | string[] | FileList | null) => void;
          ...
          <div className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <DynamicField
                ...
                onChange={(value) => onFormDataChange('dress_length', value)}
              ...
              <DynamicField
                ...
                onChange={(value) => onFormDataChange('occasion', value)}
          ...
          <div className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <DynamicField
                ...
                onChange={(value) => onFormDataChange('care_instructions', value)}
          ...
          <div className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <DynamicField
                ...
                onChange={(value) => onFormDataChange('shoe_width', value)}
              ...
              <DynamicField
                ...
                onChange={(value) => onFormDataChange('arch_support', value)}
          ...
          <div className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <DynamicField
                ...
                onChange={(value) => onFormDataChange('inseam', value)}
                error={errors.inseam}
              />
              <DynamicField
                field={{
                ...
                onChange={(value) => onFormDataChange('stretch_level', value)}
